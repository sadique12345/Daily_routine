...
- Per-task dropdowns for time, duration, type, and mood
- Daily notes
...
- Excel-compatible `.xls` export with formatted rows, frozen header, and completion colouring
...
- Your tasks, PIN, notes, and checklist history remain saved after closing the website on the same device and browser.
